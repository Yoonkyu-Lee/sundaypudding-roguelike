...
export const SKILLS: Record<string, Skill> = {
  ...
  sh_grenade: { id: "sh_grenade", name: "수류탄 투척", target: "enemy", targetMode: "allEnemies", cooldown: 3, accuracy: 85, effects: [{ kind: "damage", amount: 7 }, { kind: "applyStatus", statusId: "burn", stacks: 1, duration: 2 }] },
  ...
  shin_ult: { id: "shin_ult", name: "에이잇! 할아버지!", target: "enemy", targetMode: "allEnemies", cooldown: 4, accuracy: 85, effects: [{ kind: "damage", amount: 9 }, { kind: "applyStatus", statusId: "bleed", stacks: 1, duration: 2 }] },
  ...
  cho_martial: { id: "cho_martial", name: "비상계엄령", target: "ally", targetMode: "allAllies", cooldown: 3, accuracy: 0, alwaysHit: true, effects: [{ kind: "shield", amount: 10 }] },
  cho_police: { id: "cho_police", name: "경찰 병력 호출", target: "enemy", targetMode: "allEnemies", cooldown: 4, accuracy: 85, effects: [{ kind: "damage", amount: 6 }, { kind: "applyStatus", statusId: "paralyze", stacks: 1, duration: 2 }] },
  cho_ult: { id: "cho_ult", name: "당장 그만두시오!", target: "enemy", targetMode: "allEnemies", cooldown: 5, accuracy: 90, effects: [{ kind: "applyStatus", statusId: "fear", stacks: 3, duration: 2 }] },
  ...
  jung_charge: { id: "jung_charge", name: "전위대 돌격 명령", target: "enemy", targetMode: "allEnemies", cooldown: 3, accuracy: 85, effects: [{ kind: "damage", amount: 6 }] },
  jung_ult: { id: "jung_ult", name: "이념의 이름으로", target: "ally", targetMode: "allAllies", cooldown: 5, accuracy: 0, alwaysHit: true, grantsInterrupt: 1, grantsInterruptTo: "self", effects: [{ kind: "applyStatus", statusId: "might", stacks: 1, duration: 2 }] },
  ...
  // 심영 (탱커/도발)
  shim_speech: { id: "shim_speech", name: "사회주의 찬양 연설", target: "enemy", targetMode: "allEnemies", cooldown: 2, accuracy: 90, effects: [{ kind: "applyStatus", statusId: "weaken", stacks: 1, duration: 2 }, { kind: "applyStatusSelf", statusId: "taunt", stacks: 1, duration: 2 }] },
  ...
  shim_flag: { id: "shim_flag", name: "님을 위한 전진", target: "ally", targetMode: "allAllies", cooldown: 4, accuracy: 0, alwaysHit: true, effects: [{ kind: "shield", amount: 8 }] },
  shim_ult: { id: "shim_ult", name: "내가 고자라니!", target: "enemy", targetMode: "allEnemies", cooldown: 5, accuracy: 90, effects: [{ kind: "applyStatus", statusId: "freeze", stacks: 1, duration: 1 }] },
