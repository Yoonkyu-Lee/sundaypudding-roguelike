...
/** 상태이상 정의의 수치 필드를 스택 가중 합산 (dmgDealtFlat/critChanceAdd/critMultiplierAdd/speedMod) */
export function statusNumSum(unit: Unit, key: "dmgDealtFlat" | "critChanceAdd" | "critMultiplierAdd" | "speedMod"): number {
  let sum = 0;
