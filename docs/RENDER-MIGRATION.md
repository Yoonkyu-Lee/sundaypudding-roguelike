...
1. **전장 차원**: 2D 스프라이트 / 2.5D(2D 스프라이트 in 3D 공간, DD2식) / 풀 3D? — 씬 구조·디자이너 작업·카메라 워크를 크게 가른다. **디자이너 의견 필요.**
...
4. **착수 시점**: 지금 R1 스파이크 vs 콘텐츠/디자인 더 무르익은 뒤. (스파이크는 작아서 일찍 해도 리스크 적음 — 미지 제거 가치.)
