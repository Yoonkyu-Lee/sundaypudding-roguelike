...
- **R-run2** — 종로 입성·주먹 패권(9~29화). 민심 게이지·일기토·summon(거지패/세력 증원)·환영부활(undying+민심비례)·2페이즈 보스(구마적). 3층 ~19노드.
- **R-run3** — 일제말 항일(30~50화). 명예/민족 자원·무력 대 제도 비대칭.
- **R-run4** — 해방·좌우 대결(51~76화). 거점 공략·다수전·암살.
- **R-run5** — 사형·전쟁기(77~89화). 부활 서사·동대문 태동.
- **R-run6** — 동대문 패권·정치(90~104화). 무력화(경찰호출·투옥) 적.
- **R-run7** — 자유당 폭정·몰락(105~120화). 토사구팽 게이지(양날 성장).
- **R-run8** — 4.19·최후(121~124화). 비극형·4층·자폭 연출.
